...
class WSajuPurchaseHeaderReplays extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ContentResultBloc, ContentResultState>(
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  isLiked != null
                      ? InkWell(
                          onTap: authenticationBloc.state.user != null
                              ? () {
                                  var bloc = context.read<ContentResultBloc>();
